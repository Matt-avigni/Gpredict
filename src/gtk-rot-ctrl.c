...
#ifdef G_OS_WIN32
/* Windows often holds the old child/port briefly after process teardown. */
#define ROTCTLD_AUTODETECT_PORT_FREE_TIMEOUT_MS 1500
#define ROTCTLD_AUTODETECT_COOLDOWN_MS 400
#else
